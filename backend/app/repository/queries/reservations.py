...
def change_reservation_db(id: int, stand_id: int, start_time: str, duration: str):
    query = f"""
            UPDATE reservations SET stand_id = '{stand_id}', start_time = '{start_time}', duration = '{duration}'
            WHERE id = '{id}'
            """
    return execute_db_query(query)
